...
<head>
  ...
  <title>Meeting and Conference  Booking System | Accepted Bookings</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $_GET['uname']?>'s Bookings</h1>
          </div>
          <div class="col-sm-6">
...
$query=mysqli_query($con,"select tblrooms.id,tblbookings.bookingNo,tblbookings.bookingDate,tblbookings.postingDate,tblbookings.companyIndivadualName, tblrooms.roomTitle, tblrooms.roomType,tblbookings.id as bookid,boookingStatus from tblbookings
join  tblrooms on tblbookings.roomId=tblrooms.id where (tblbookings.userId='$uid')");
$cnt=1;
...
?>
                  ...
                  <tr>
                    ...
                    if( $bstatus==''): echo "Not Processed Yet";
                        else: echo $bstatus; endif;?><br />
                    </td>
