...
<head>
  ...
  <title>Meeting and Conference Booking System  | Dashboard</title>
...
?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
 <?php $query3=mysqli_query($con,"select * from tblbookings where (boookingStatus is null || boookingStatus='')");
...
<hr />
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
<?php $query11=mysqli_query($con,"select * from tblbookings where (boookingStatus='Approved')");
...
?>
              ...
              <a href="approved-bookings.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
<?php $query12=mysqli_query($con,"select * from tblbookings where (boookingStatus='Canceled')");
...
?>
              ...
              <a href="canceled-bookings.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
   ...
   <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
<?php $query=mysqli_query($con,"select id from tblusers");
$regusers=mysqli_num_rows($query);
?>


                <h3><?php echo $regusers;?></h3>
                <p>Reg. Users</p>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
