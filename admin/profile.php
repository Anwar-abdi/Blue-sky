...
<head>
  ...
  <title>Meeting and Conference Booking System  | My Profile</title>
...
<!--  admin Contact Number---->
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter email" pattern="[0-9]{10}" title="12 numeric characters only" maxlength="12" required value="<?php echo $result['MobileNumber'];?>">
                  </div>

<!--  admin Profile Reg. Date---->
                  <div class="form-group">
                    <label for="text">Registration Date</label>
                    <<input type="date" class="form-control" id="regdate" name="regdate" required value="<?php echo $result['AdminRegdate'];?>">
