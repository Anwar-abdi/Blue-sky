        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Cenceled Bookings</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
join  tblrooms on tblbookings.roomId=tblrooms.id where (boookingStatus='Canceled')");
$cnt=1;
...
?>
                  ...
                  <tr>
                    ...
                    <td><span class="badge badge-danger"><?php echo $row['boookingStatus']; ?></span>
                    </td>
