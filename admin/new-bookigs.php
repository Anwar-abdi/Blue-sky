...
<head>
  ...
  <title>Meeting and Conference Booking System  | New Bookings</title>
...
join  tblrooms on tblbookings.roomId=tblrooms.id where (boookingStatus is null || boookingStatus='')");
$cnt=1;
