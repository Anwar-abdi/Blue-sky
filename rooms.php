...
<html lang="en">
    <head>
        ...
        <title>Meeting and Conference  Booking System | Rooms </title>
        <!-- Favicon-->
...
?> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="admin/roomimages/<?php echo htmlentities($row['roomImage']);?>" width="350" height="300" alt="<?php echo htmlentities($row['roomTitle']);?>" />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <!-- Product price-->
                                   Price Per Day - $<?php echo htmlentities($row['roomPpday']);?>
                                </div>
                            </div>
                            <!-- Product actions-->
